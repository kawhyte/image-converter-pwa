  ...
  return (
    <div className="bg-zinc-950 text-white min-h-screen font-sans">
      ...
      <div className="text-center py-20 sm:py-32 px-4 sm:px-6 lg:px-8 border-b border-zinc-800">
        <h1 className="font-grotesk text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-50 mb-4">
      ...
      <div className="max-w-5xl mx-auto py-16 sm:py-24 px-4 sm:px-6 lg:px-8 space-y-20">
        ...
        <section className="grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            <h2 className="font-grotesk text-3xl font-bold text-gray-50 mb-4">The Burden of the Bloat.</h2>
        ...
        <section>
          <h2 className="font-grotesk text-3xl font-bold text-gray-50 text-center mb-12">Our Core Principles.</h2>
          <div className="grid sm:grid-cols-3 gap-8 text-center">
            ...
            <div className="p-6 bg-zinc-900 rounded-xl">
              ...
              <h3 className="font-grotesk text-xl font-semibold mb-2">Quality</h3>
        ...
        <section className="text-center  rounded-xl py-12 sm:py-16 px-6">
            <h2 className="font-grotesk text-3xl sm:text-4xl font-extrabold text-white mb-4">Ready to Speed Up Your Site?</h2>
